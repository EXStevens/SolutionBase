...
- **Concept explanations**  
  Straightforward notes that break down key CS ideas in a friendly and readable way.

- **Practical guides**  
  Setup instructions, environment notes, and small “fix lists” for common issues.

- **Project documentation**  
  Overviews, design decisions, references, and internal notes for things I’m building.
...
- Visit the **What's up?** from the top navigation bar for some updates and small thoughts I consider worth sharing.
